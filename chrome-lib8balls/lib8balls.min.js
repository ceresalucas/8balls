var util = (function () {
    ...
    a.flipElement = function (b, d) {
        ...
        var e = {0: "bottom", 270: "right", 180: "top", 90: "left"};
...
var dataminer = (function () {
    ...
    var b = ["ward", "ban", "cinzou", "procede", "masturbamento", "hora da punhetinha", "link do cachorro", "wow", "nao há vagas", "eh nois carai",
             "no drugs", "vip", "cremosa", "vai pro porao", "voteban", "+18", "repost", "não add"]
    var h = ["mameluco", "mina", "vamp", "bigas", "kunitaka", "malaquias", "ballers", "relâmpago marquinhos", "zuckerberg"];
    var d = ["8balls", "facebookson"];
    var g = {meta: null, content: null};
    var f = function () {
        //var n;
        //var k = [];
    ...
    a.getSentence = function () {
        ...
        var w1 = b[util.random(0, b.length-1)];

        var w2 = h[util.random(0, h.length-1)];

        var w3 = d[util.random(0, d.length-1)];

        var msg = [w1, w2];

        if(util.random(0,100) > 70){
            msg.push(w3)
        }
...
var doge = function (a) {
    ...
    var j;
    var c = {
        right: "https://github.com/ceresalucas/8balls/blob/master/chrome-lib8balls/img/kuni.png?raw=true",
        left: "https://github.com/ceresalucas/8balls/blob/master/chrome-lib8balls/img/kuni_r.png?raw=true"
    };
    var img_list = [
        "https://github.com/ceresalucas/8balls/blob/master/chrome-lib8balls/img/8_256x256-32.png?raw=true",
        "https://github.com/ceresalucas/8balls/blob/master/chrome-lib8balls/img/bigas.jpg?raw=true"
    ];
    (function () {
        b = "doge-" + a + "-" + (new Date().getTime());
        h = document.createElement("img");
        h.style = "filter: drop-shadow(5px -5px 5px black);";
        h.setAttribute("id", b);
        var d = ["left", "right"];
    ...
    g.bark = function () {
        ...
        if(util.random(0, 100) > 80) {
            ...
            img.width=50;
            img.src = img_list[util.random(0, img_list.length-1)];
            o.appendChild(img);
        }else {
